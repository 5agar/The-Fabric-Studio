...
if (isset($_POST['upload'])) {
	...
	$db = mysqli_connect("localhost", "root", "", "users");
		...
		$sql = "INSERT INTO products (pname, pimg, pcategory, time, price) VALUES ('$pname', '$folder', '$pcategory', '$time', '$price')";
...
<div class="content">
	...
	<form method="POST" action="" enctype="multipart/form-data">
				...
				<label class="text1">Average Stitching Time (Days):</label><br />
